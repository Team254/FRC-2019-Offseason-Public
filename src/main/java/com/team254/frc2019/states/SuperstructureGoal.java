...
public class SuperstructureGoal {
    ...
    public SuperstructureGoal(double elevator, double shoulder, double wrist) {
        this(new SuperstructureState(elevator, shoulder, wrist));
    }
    ...
    public boolean equals(SuperstructureGoal other) {
        return this.state.elevator == other.state.elevator &&
