...
public class CarriageCanifier extends Subsystem {
    ...
    private CarriageCanifier() {
        ...
        mCanifierArm.setStatusFramePeriod(CANifierStatusFrame.Status_2_General, 10, Constants.kLongCANTimeoutMs);
        mCanifierWrist.setStatusFramePeriod(CANifierStatusFrame.Status_2_General, 10, Constants.kLongCANTimeoutMs);
    ...
    public synchronized void readPeriodicInputs() {
        mPeriodicInputs.has_ball_ = mCanifierArm.getGeneralInput(CANifier.GeneralPin.LIMF);
        PinValues pinValues = new PinValues();
        mCanifierWrist.getGeneralInputs(pinValues);
